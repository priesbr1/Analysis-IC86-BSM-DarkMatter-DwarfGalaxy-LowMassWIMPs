...
parser.add_argument("-o", "--outfile", type=str, default="/mnt/home/priesbr1/DM_Search/data/cross_section_results/cross_section_results_360deg_Jmax_modified.npy",
...
# Injector
inj = PointSourceInjector(spectrum=spectra, E0=spectra.E0)
